...
variable "cloud-access-token" {
  type    = string
  default = "glc_eyJvIjoiMTEyODY2MSIsIm4iOiJzdGFjay05MzYzMzUtaG0td3JpdGUtMDkxNzI0dGVtcCIsImsiOiI2b2Y1V0JyMWl6T0xTWjEzeks5NzExMlYiLCJtIjp7InIiOiJwcm9kLXVzLWVhc3QtMCJ9fQ=="
}
